...
class BaseController extends Controller {
    ...
    public function checkPriv(){
        ...
        $free_action = array(
			...
			'admin.saleissue.getsalelist','admin.pricetemplate.getsalehotel','admin.basicset.getajaxdepartmentusers','admin.hotel.getcitylist','admin.goodspolicy.getsalehotel'
        );
